...
export const metadata: Metadata = {
  title: 'PR11 Parboiled Rice Exporter | Premium Non-Basmati Long Grain',
  description:
    'Exporter of high-quality PR11 Parboiled Rice. Long grain, parboiled for better nutrition, moisture-controlled, export-grade. Bulk supply worldwide.',
  keywords: [
    'PR11 Parboiled Rice Exporter',
    'PR11 Non-Basmati Rice Supplier',
    'Indian Parboiled Rice Bulk Export',
    'Long Grain PR11 Rice FOB',
    'Export-Ready PR11 Rice',
  ],
  openGraph: {
    title: 'PR11 Parboiled Rice Exporter | Premium Long Grain',
    description:
      'Premium PR11 Parboiled Non-Basmati Rice exporter. Export-quality, long grain, moisture-controlled, and bulk supply ready for international buyers.',
    type: 'website',
  },
};

export default function PR11Page() {
  return (
    <>
      {/* ================= PR11 PARBOILED RICE HERO ================= */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-28">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <nav className="flex justify-center lg:justify-start mb-6 text-sm text-green-200">
                <ol className="flex items-center gap-2">
                  ...
                  <li className="opacity-60">/</li>
                  <li className="text-[#F4B400] font-medium">PR11 Parboiled</li>
                </ol>
              </nav>
              ...
              <h1 className="text-3xl md:text-4xl font-bold leading-tight">
                PR11 Parboiled Non-Basmati Rice
              </h1>

              <p className="text-3xl md:text-4xl font-bold leading-tight mb-6 text-[#F4B400] mt-3">
                Long Grain, Nutritious & Export-Ready
              </p>

              {/* Description */}
              <p className="text-lg md:text-xl text-green-100 mb-8 max-w-xl mx-auto lg:mx-0">
                INFI EXPORT supplies premium PR11 Parboiled rice, known for its
                long grains, enhanced nutrition, non-sticky texture, and
                superior cooking quality. Perfect for bulk importers and
                international distributors seeking parboiled rice for industrial
                or retail use.
              </p>
            ...
            <div className="relative w-full h-[420px] lg:h-[540px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/rice/non-basmati/pr11-parboiled-rice.jpg"
                alt="PR11 Parboiled Non-Basmati Rice Long Grain Export Quality"
                fill
              ...
              <div className="absolute bottom-6 left-6 bg-white/10 backdrop-blur-md px-6 py-4 rounded-xl border border-white/20">
                ...
                <p className="text-xl font-semibold text-white">
                  Premium PR11 Parboiled Quality
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-4xl font-bold text-emerald-800 mb-6">
              PR11 Parboiled Rice Overview
            </h2>

            <p className="text-gray-700 text-lg leading-relaxed mb-10">
              PR11 Parboiled Rice is a premium Non-Basmati variety, parboiled
              for better nutrition, texture, and cooking performance. It is
              perfect for international distributors, food processors, and bulk
              buyers who need high-quality parboiled rice.
            </p>
              ...
              {[
                {
                  ...
                  desc: '6.0–6.5mm uniform grains, ideal for industrial and retail purposes.',
                },
                {
                  title: 'Parboiled & Nutritious',
                  desc: 'Enhanced nutrition and improved shelf life through controlled parboiling.',
                },
                {
                  title: 'Export-Grade Quality',
                  desc: 'Moisture controlled and low broken percentage to meet international standards.',
                },
                {
                  title: 'Bulk Supply Ready',
                  desc: 'Flexible packaging options tailored for global buyers.',
                },
              ].map((feature, idx) => (
                <div
                  key={idx}
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-emerald-100 p-10">
            ...
            <div className="space-y-6">
              {[
                { label: 'Average Grain Length', value: '6.0–6.5mm' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-gray-600 text-lg">
              ...
              for PR11 Parboiled Rice from India, maintaining international
            ...
            {[
              {
                ...
                desc: 'PR11 Parboiled rice sourced from trusted, export-certified mills in India.',
              },
              {
                icon: PackageCheck,
                title: 'Inspection & Packaging',
                desc: 'Batch-wise quality inspection with export-ready packaging tailored for international buyers.',
              },
              {
                icon: Ship,
