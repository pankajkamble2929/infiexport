...
export const metadata: Metadata = {
  title: 'Sona Masoori Non-Basmati Rice Exporter | Premium Indian Long Grain',
  description:
    'Exporter of high-quality Sona Masoori Non-Basmati Rice. Long grain, low moisture, export-grade quality. Bulk supply available with FOB shipping worldwide.',
  keywords: [
    'Sona Masoori Non-Basmati Rice Exporter',
    'Sona Masoori Rice Supplier India',
    'Indian Long Grain Non-Basmati Rice',
    'Bulk Sona Masoori Rice Export',
    'Non-Basmati Rice FOB',
  ],
  openGraph: {
    title: 'Sona Masoori Non-Basmati Rice Exporter | Premium Long Grain',
    description:
      'Exporter of premium Sona Masoori Non-Basmati Rice with long grains, moisture-controlled, and bulk supply ready for international markets.',
    type: 'website',
  },
};

export default function SonaMasooriPage() {
  return (
    <>
      {/* ================= SONA MASOORI HERO ================= */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-28">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <nav className="flex justify-center lg:justify-start mb-6 text-sm text-green-200">
                <ol className="flex items-center gap-2">
                  ...
                  <li className="opacity-60">/</li>
                  <li className="text-[#F4B400] font-medium">Sona Masoori</li>
                </ol>
              </nav>
              ...
              <p className="text-3xl md:text-4xl font-bold leading-tight mb-6 text-[#F4B400] mt-3">
                Lightweight, Aromatic, Ideal for Global Export
              </p>

              {/* Description */}
              <p className="text-lg md:text-xl text-green-100 mb-8 max-w-xl mx-auto lg:mx-0">
                INFI EXPORT provides premium Sona Masoori rice, valued for its
                medium-long grains, light texture, low starch, and consistent
                cooking performance. Perfect for bulk importers, international
                wholesalers, and food processing companies.
              </p>
            ...
            <div className="relative w-full h-[420px] lg:h-[540px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/rice/non-basmati/sona-masoori-rice.jpg"
                alt="Sona Masoori Non-Basmati Rice Long Grain Export Quality"
                fill
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-4xl font-bold text-emerald-800 mb-6">
              Sona Masoori Rice Overview
            </h2>

            <p className="text-gray-700 text-lg leading-relaxed mb-10">
              Sona Masoori rice is a lightweight, medium-long Non-Basmati
              variety highly preferred in export markets. Its non-sticky
              texture, low starch, and easy cooking make it perfect for
              international wholesalers and food brands.
            </p>

            <div className="grid sm:grid-cols-2 gap-6">
              {[
                {
                  title: 'Medium-Long Grain',
                  desc: '5.5–6.0mm grains, light and uniform.',
                },
                {
                  title: 'Non-Sticky Texture',
                  desc: 'Ideal for professional food use and everyday cooking.',
                },
                {
                  title: 'Moisture Controlled',
                  desc: 'Ensures longer shelf life and export-quality standards.',
                },
                {
                  title: 'Bulk Export Ready',
                  desc: 'Flexible packaging options for international buyers.',
                },
              ].map((feature, idx) => (
                <div
                  key={idx}
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-emerald-100 p-10">
            ...
            <div className="space-y-6">
              {[
                { label: 'Average Grain Length', value: '5.5–6.0mm' },
                { label: 'Moisture Content', value: 'Max 12-13%' },
                { label: 'Broken Percentage', value: '2% Max' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-gray-600 text-lg">
              From certified sourcing to international delivery, INFI EXPORT
              ensures strict quality standards for Sona Masoori Non-Basmati rice
              at every stage.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Sona Masoori rice sourced from trusted, export-certified Indian mills ensuring consistent grain quality.',
              },
              {
                icon: PackageCheck,
                title: 'Inspection & Packaging',
                desc: 'Each batch undergoes strict inspection and is packed in export-ready bags tailored for bulk buyers.',
              },
              {
                icon: Ship,
                title: 'Container Loading & Global Shipping',
                desc: 'Efficient shipping, documentation, and international logistics ensure timely delivery worldwide.',
              },
            ].map((step, idx) => {
