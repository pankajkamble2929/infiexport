...
export const metadata: Metadata = {
  title: 'IR64 Non-Basmati Rice Exporter | Premium Indian Long Grain Supplier',
  description:
    'Exporting high-quality IR64 Non-Basmati Rice from India. Long grain, low moisture, export-grade quality. Bulk supply available with FOB shipping worldwide.',
  keywords: [
    'IR64 Non-Basmati Rice Exporter',
    'IR64 Rice Supplier India',
    'Indian Long Grain Non-Basmati Rice',
    'Bulk IR64 Rice Export',
    'Non-Basmati Rice FOB',
  ],
  openGraph: {
    title: 'IR64 Non-Basmati Rice Exporter | Premium Long Grain',
    description:
      'Exporter of premium IR64 Non-Basmati Rice with long grains, moisture-controlled, and bulk supply ready for international markets.',
    type: 'website',
  },
};

export default function IR64Page() {
  return (
    <>
      {/* ================= IR64 NON-BASMATI HERO ================= */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-28">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <nav className="flex justify-center lg:justify-start mb-6 text-sm text-green-200">
                <ol className="flex items-center gap-2">
                  ...
                  <li className="opacity-60">/</li>
                  <li className="text-[#F4B400] font-medium">IR64 Rice</li>
                </ol>
              </nav>
              ...
              <p className="text-3xl md:text-4xl font-bold leading-tight mb-6 text-[#F4B400] mt-3">
                Long Grain, Non-Sticky, Ideal for Global Export
              </p>

              {/* Description */}
              <p className="text-lg md:text-xl text-green-100 mb-8 max-w-xl mx-auto lg:mx-0">
                INFI EXPORT offers top-quality IR64 Non-Basmati rice, renowned
                for its long grains, low moisture content, uniform size, and
                non-sticky texture. Perfect for international bulk buyers,
                wholesalers, and food processing brands.
              </p>
            ...
            <div className="relative w-full h-[420px] lg:h-[540px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/rice/non-basmati/ir64-rice.jpg"
                alt="IR64 Non-Basmati Rice Long Grain Export Quality"
                fill
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-4xl font-bold text-emerald-800 mb-6">
              IR64 Non-Basmati Rice Overview
            </h2>

            <p className="text-gray-700 text-lg leading-relaxed mb-10">
              IR64 rice is a premium long grain Non-Basmati variety popular in
              export markets. Known for its uniform grain, non-sticky texture,
              and consistent cooking, it is ideal for international food brands
              and wholesalers.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                {
                  title: 'Uniform Long Grain',
                  desc: '6.5–7.0mm grains with consistent size and shape.',
                },
                {
                  title: 'Non-Sticky Texture',
                  desc: 'Perfect for everyday cooking and professional food use.',
                },
                {
                  title: 'Moisture Controlled',
                  desc: 'Low moisture content ensures longer shelf life and quality.',
                },
                {
                  title: 'Bulk Export Ready',
                  desc: 'Flexible packaging options for global buyers and importers.',
                },
              ].map((feature, idx) => (
                <div
                  key={idx}
      ...
      {/* Same layout as Basmati page, rewrite content for IR64 Non-Basmati */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-gray-600 text-lg">
              From certified sourcing to international delivery, we maintain
              strict quality standards for IR64 Non-Basmati rice at every stage.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'IR64 rice sourced from trusted, export-certified Indian mills ensuring consistent grain quality.',
              },
              {
                icon: PackageCheck,
                title: 'Inspection & Packaging',
                desc: 'Each batch is inspected and packed in export-grade bags suitable for bulk buyers worldwide.',
              },
              {
                icon: Ship,
                title: 'Container Loading & Global Shipping',
                desc: 'Efficient shipping and documentation ensure timely delivery to all major international markets.',
              },
            ].map((step, idx) => {
